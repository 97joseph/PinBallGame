...
attribute is of type WORD and holds both fore and background
colour information.
...
/*
This class provides a public access structure to hold
a single character, its colour attributes and its 
...
public:
	...
	void print(int x, int y, const char m[], int nbrClear = 0)
	{
		...
		// If nbrClear is an acceptable value i.e. does not 
		// extend beyond the end of the line then use it
